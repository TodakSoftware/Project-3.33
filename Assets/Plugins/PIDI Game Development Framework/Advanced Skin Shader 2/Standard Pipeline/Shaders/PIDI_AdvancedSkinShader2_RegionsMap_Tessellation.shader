Shader "PIDI Shaders Collection/Advanced Skin Shader 2/Realistic/Regions Map + Tessellation" {
	Properties {
		[Header(Tessellation Parameters)][Space(8)]
		_PSkinEdgeLength( "Edge Length", Range(2,64) ) = 8
		_PSkinPhong( "Phong Smoothness", Range(0,1) ) = 0.5
		...
		[PerRendererData] _PSkinBaseNormals ("Normalmap", 2D) = "bump" {}
	...
	SubShader {
		...
		#pragma surface surf AdvancedSkin vertex:vert fullforwardshadows addshadow tessellate:tessEdge tessphong:_PSkinPhong
        ...
        float4 tessEdge (appdata v0, appdata v1, appdata v2){
            return UnityEdgeLengthBasedTess (v0.vertex, v1.vertex, v2.vertex, _PSkinEdgeLength);
        }
	...
	FallBack "PIDI Shaders Collection/Advanced Skin Shader 2/Realistic/TensionMap"
}

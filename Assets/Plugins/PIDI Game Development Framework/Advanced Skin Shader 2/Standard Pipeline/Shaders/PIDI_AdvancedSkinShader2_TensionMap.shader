Shader "PIDI Shaders Collection/Advanced Skin Shader 2/Realistic/TensionMap" {
	Properties {
	...
	SubShader {
		...
		#pragma surface surf AdvancedSkin vertex:vert fullforwardshadows addshadow vertex:vert
	...
	FallBack "PIDI Shaders Collection/Advanced Skin Shader 2/Realistic/TensionMap (Mobile)"
}
